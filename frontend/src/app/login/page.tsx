          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="text-center mb-6">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-500 rounded-2xl mb-3 flex-shrink-0">
                <svg className="w-9 h-9 text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" />
                </svg>
              </div>
              <h1 className="text-xl font-bold text-blue-500">⚡HCMSIU SSPS⚡</h1>
            ...
            {GOOGLE_CLIENT_ID ? (
              ...
              <button
                type="button"
                disabled={true}
                className="w-full flex items-center justify-center gap-3 bg-gray-100 border border-gray-200 text-gray-400 py-2.5 rounded-lg font-medium cursor-not-allowed mb-4 text-sm"
              >
