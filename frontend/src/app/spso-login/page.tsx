    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-teal-500/5 rounded-full blur-2xl"></div>
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          {/* Logo */}
          <div className="mb-8">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-emerald-400 to-cyan-500 rounded-2xl shadow-2xl shadow-emerald-500/25">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <span className="text-slate-300">Quản lý máy in & thống kê</span>
            </div>
            <div className="flex items-center gap-4">
              ...
              <span className="text-slate-300">Quản lý người dùng hệ thống</span>
            </div>
            <div className="flex items-center gap-4">
              ...
              <span className="text-slate-300">Cấu hình hệ thống linh hoạt</span>
            </div>
          </div>
        </div>
        ...
        <div className="absolute bottom-8 left-16 text-slate-500 text-sm">
          © 2024 HCMIU SSPS. All rights reserved.
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-slate-50">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            <h1 className="text-xl font-bold text-slate-800">HCMIU SSPS</h1>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 p-8 border border-slate-100">
            {/* Header */}
            <div className="mb-8">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-emerald-50 text-emerald-600 rounded-full text-xs font-medium mb-4">
              ...
              <p className="text-slate-500 text-sm">Nhập thông tin để truy cập hệ thống quản trị</p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all duration-200"
                    disabled={isLoading}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-12 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all duration-200"
                    disabled={isLoading}
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center cursor-pointer group">
                  <input
                    ...
                    className="w-4 h-4 text-emerald-500 border-slate-300 rounded focus:ring-emerald-500 focus:ring-offset-0"
                    disabled={isLoading}
                  />
                  <span className="ml-2 text-sm text-slate-600 group-hover:text-slate-800 transition-colors">Ghi nhớ đăng nhập</span>
                </label>
            ...
            <div className="mt-8 pt-6 border-t border-slate-100">
              ...
              <p className="text-center text-xs text-slate-400 mt-2">
                Liên hệ hỗ trợ: <a href="mailto:support@hcmiu.edu.vn" className="text-emerald-600 hover:underline">support@hcmiu.edu.vn</a>
              </p>
            </div>
          </div>
