...
class StudentServiceImplTest {
    ...
    void setUp() {
        ...
        testPageBalance.setA4Balance(100); // 100 A4 pages (can print 50 A3 or 100 A4)
    ...
    void testGetStudentDetail_Success() {
        ...
        assertEquals(0, result.getA3Balance()); // System stores only A4 equivalent
        assertEquals(100, result.getTotalA4Equivalent()); // Total A4 equivalent
